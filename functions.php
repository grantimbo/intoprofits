...
function remove_menus() {
    ...
    if ( current_user_can('editor') ) {
        ...
        remove_menu_page( 'edit.php?post_type=custom-settings' );       //Custom Settings
