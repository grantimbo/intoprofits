		...
		<header class="header clear">
			<div class="wrap">
				<div class="mobile-menu-wrap">
					...
					<a class="logo" href="<?php echo $siteLink; ?>"><img src="<?php echo $tempLink; ?>/img/logo-black.webp" alt="Into Profits" width="200" height="23"></a>
					<?php head_nav(); ?>
					</header>
				</div>
	...
	<footer>
		...
		<div class="primary">
			<div class="wrap clear">
				<img src="<?php echo $tempLink; ?>/img/footer-logo.webp" alt="Apex Seller" width="36" height="38">
				<?php footer_nav(); ?>
			</div>
		</div>	
			...
			<div class="wrap clear">
				<div class="copyright">
					...
					<div class="copyright-links">
						<a style="margin-right: 20px;" href="<?php echo $siteLink; ?>/privacy-policy">Privacy &amp; Legal</a>
						<a href="<?php echo $siteLink; ?>/contact">Contact</a>
					</div>
				</div>
